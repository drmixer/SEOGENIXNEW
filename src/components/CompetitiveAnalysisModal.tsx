...
const CompetitiveAnalysisModal: React.FC<CompetitiveAnalysisModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-0 sm:p-4 z-50">
      <div className="bg-white w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-2xl shadow-2xl flex flex-col">
        ...
        <div className="flex justify-end p-4 sm:p-6 bg-gray-50 sm:rounded-b-2xl space-x-3">
          <button
            onClick={onClose}
