/*
  ...
  1. Changes
    - Creates a temporary table to identify duplicate profiles
    - Keeps only the most recent profile for each user
    - Adds a unique constraint on user_id to prevent future duplicates
*/
