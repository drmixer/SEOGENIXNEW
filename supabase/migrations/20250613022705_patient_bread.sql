/*
  ...
  1. New Storage Bucket
    - `reports` bucket for storing generated report files
    - 50MB file size limit
    - Allowed MIME types: JSON, CSV, HTML, PDF
  
  2. Security
    - Creates policies for the storage.objects table if they don't exist
    - Ensures users can only access their own reports
    - Provides public read access for report downloads via signed URLs
*/
