...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const response = {
      ...
      modeUsed: usedPath,
      instructions: [
        'Copy the <script type="application/ld+json"> block.',
        'For static HTML, paste it inside <head> or before </body>.',
        'In WordPress or other CMSs, use a header/footer script area or theme template.',
