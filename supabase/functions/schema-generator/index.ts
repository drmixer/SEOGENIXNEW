...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const response = {
      ...
      modeUsed: usedPath,
      instructions:
        '1. Copy the <script type="application/ld+json"> block.\n2. For static HTML, paste it inside <head> or before </body>.\n3. In WordPress or other CMSs, use a header/footer script area or theme template.\n4. Include only one schema block per page.'
    };
